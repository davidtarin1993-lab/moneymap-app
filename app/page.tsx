            ...
            <div className="space-y-3">
              ...
              <div className="flex items-baseline gap-1">
                {planLead === 'mensual' ? (
                  ...
                  <>
                    <span className="text-4xl font-black text-[#0B3A6E]">120€</span>
                    <span className="text-slate-500 text-xs font-bold">/ al año</span>
                    <span className="text-[10px] text-[#1FA187] font-black ml-1">(equivale a 10€/mes)</span>
                  </>
                )}
              </div>

              {/* Lista de características */}
              <ul className="space-y-3 text-left pt-3">
