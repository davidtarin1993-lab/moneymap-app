...
function QuizPublicoContenido() {
  ...
  const RECOMENDACIONES: Record<string, string> = {
    ...
    Presupuesto: "Prueba a revisar tus movimientos con regularidad — te ayudará a detectar patrones de gasto sin necesidad de una hoja de cálculo.",
    ...
    Planificación: "Marca un objetivo con cifra y fecha concreta (ej. '10.000€ en 3 años para la entrada de un piso') y traza un plan claro para conseguirlo.",
  };
    ...
    await generarPdfResultado({
      ...
      secciones: [
        ...
        },
        {
          ...
          contenido: `Tu área con más margen de mejora es ${categoriaMasDebil.categoria}. ${RECOMENDACIONES[categoriaMasDebil.categoria]}`,
        },
      ],
      ...
      <div className="max-w-lg mx-auto w-full">
        ...
        <header className="border-b border-slate-100 pb-5 mb-5 text-center">
          ...
          <p className="mt-2 text-xs md:text-sm text-slate-500 max-w-md mx-auto font-medium leading-normal">
            40 preguntas rápidas para descubrir tus puntos fuertes y en qué deberías mejorar. Gratis, sin registro.
          </p>
        </header>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-[#1FA187]/10 border border-[#1FA187]/30 rounded-2xl p-5 text-center">
              ...
              <p className="text-[11px] text-slate-500 font-medium mb-3">
                MoneyMap analiza tus movimientos y tu fiscalidad con IA, y traza contigo una ruta financiera real.
              </p>
              <Link
                href="/"
