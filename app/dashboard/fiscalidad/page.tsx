...
const MOVIMIENTOS_REALES: Movimiento[] = [
  { fecha: '2026-04-30', descripcion: 'ABONO TR. David Tarin', importe: 350, tipo: 'ingreso', categoriaReducida: 'Ingresos', naturaleza: 'no aplica', esencialidad: 'no aplica' },
  { fecha: '2026-04-30', descripcion: 'LIQUIDACIÓN TARJETA CREDITO', importe: -799.52, tipo: 'gasto', categoriaReducida: 'Transferencias', naturaleza: 'fijo', esencialidad: 'importante' },
  { fecha: '2026-04-29', descripcion: 'NOMINA PRINCIPAL', importe: 2822.02, tipo: 'ingreso', categoriaReducida: 'Ingresos', naturaleza: 'no aplica', esencialidad: 'no aplica' },
  { fecha: '2026-04-14', descripcion: 'GAS TotalEnergies', importe: -31.99, tipo: 'gasto', categoriaReducida: 'Vivienda', naturaleza: 'fijo', esencialidad: 'esencial' },
  { fecha: '2026-04-10', descripcion: 'PRESTAMOS ADEUDO CUOTA', importe: -734.55, tipo: 'gasto', categoriaReducida: 'Finanzas', naturaleza: 'fijo', esencialidad: 'esencial' },
  { fecha: '2026-04-10', descripcion: 'TELEFONO: Simyo', importe: -31.49, tipo: 'gasto', categoriaReducida: 'Suscripciones', naturaleza: 'fijo', esencialidad: 'esencial' },
  { fecha: '2026-04-09', descripcion: 'AGUA AGUAS DE VALENCIA', importe: -65.45, tipo: 'gasto', categoriaReducida: 'Vivienda', naturaleza: 'fijo', esencialidad: 'esencial' },
  { fecha: '2026-03-31', descripcion: 'TARJETA CREDITO LIQUIDACION', importe: -2301.40, tipo: 'gasto', categoriaReducida: 'Transferencias', naturaleza: 'fijo', esencialidad: 'importante' },
  { fecha: '2025-09-22', descripcion: 'COMPRA TARJETA MERCADONA', importe: -108.26, tipo: 'gasto', categoriaReducida: 'Alimentación', naturaleza: 'variable', esencialidad: 'esencial' },
  { fecha: '2025-02-25', descripcion: 'COMPRA BIZUM QATAR AIRWAYS', importe: -1099.98, tipo: 'gasto', categoriaReducida: 'Ocio y viajes', naturaleza: 'variable', esencialidad: 'discrecional' }
];

export default function MoneyMapDashboard() {
  // ==========================================
  // 2. ESTADOS DE FILTRADO TEMPORAL
  // ==========================================
  const [fechaInicio, setFechaInicio] = useState<string>('2025-01-01');
  const [fechaFin, setFechaFin] = useState<string>('2026-06-30');

  // Filtrado de movimientos por fechas
  const movimientosFiltrados = useMemo(() => {
    return MOVIMIENTOS_REALES.filter(mov => {
